...
export default function GuideSection( { section, bulk, searching } ) {
	return (
		<section id={ section.id } className="tazeen-store-accessibility-kit-for-woocommerce-guide-section">
			<h2>{ section.title }</h2>
			{ section.intro && <p className="tazeen-store-accessibility-kit-for-woocommerce-guide-intro">{ section.intro }</p> }
