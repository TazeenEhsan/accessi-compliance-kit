...
- Namespace: `accessibility-compliance-kit-for-woocommerce/v1` (proposal §5.4)
...
|---|---|---|---|
| `/accessibility-compliance-kit-for-woocommerce/v1/scans` | GET | List scans (paged; mirrors History tab data) | scan read |
| `/accessibility-compliance-kit-for-woocommerce/v1/scans` | POST | Trigger a scan (Pro: server-driven crawl; enables CI/CD per §4.2.I) | scan run |
| `/accessibility-compliance-kit-for-woocommerce/v1/scans/{id}` | GET | One scan with full normalized violations | scan read |
| `/accessibility-compliance-kit-for-woocommerce/v1/reports/{id}` | GET | Fetch a generated report (Pro, §4.2.F) | report read |
...
- **WP-CLI** (§4.2.F): `wp accessibility-compliance-kit-for-woocommerce scan`, `wp accessibility-compliance-kit-for-woocommerce report` — same service layer, enables staging scans on deploy.
