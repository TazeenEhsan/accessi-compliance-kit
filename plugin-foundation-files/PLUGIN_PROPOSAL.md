# Plugin Proposal: Accessibility Compliance Kit for WooCommerce — WooCommerce Accessibility Compliance
...
**Plugin name (working):** Accessibility Compliance Kit for WooCommerce
...
- **Full white-label** — replace "Accessibility Compliance Kit for WooCommerce" branding with agency name/logo throughout admin UI
...
- **Client-facing reports** with agency branding, no mention of Accessibility Compliance Kit for WooCommerce
...
**Custom table: `wp_accessibility_compliance_kit_for_woocommerce_scans`**
...
- `accessibility_compliance_kit_for_woocommerce_settings` — plugin configuration array
- `accessibility_compliance_kit_for_woocommerce_active_fixes` — which fixes are enabled
- `accessibility_compliance_kit_for_woocommerce_license` — Pro license data (via Freemius or custom)
- `accessibility_compliance_kit_for_woocommerce_last_scan_id` — pointer for dashboard widget
...
- `wp_ajax_accessibility_compliance_kit_for_woocommerce_run_scan` — AJAX endpoint for scans
- `wp_ajax_accessibility_compliance_kit_for_woocommerce_save_settings` — settings save
...
2. Plugin opens a hidden iframe pointing at the target URL with a query string flag `?accessibility_compliance_kit_for_woocommerce_scan=1`
...
5. Parent window sends results to `admin-ajax.php` action `accessibility_compliance_kit_for_woocommerce_run_scan`
6. PHP saves to the `wp_accessibility_compliance_kit_for_woocommerce_scans` table
